...
#	remove="rm /var/www/htdocs/${csv[2]}/${csv[2]}"
#	eval $remove
#	index="printf \"<html>\n<head>\n</head>\n<body>\n<h1>Welcome to ${csv[1]} ${csv[0]}'s userspace\n </h1></body></html>\" > 
#/var/www/htdocs/${csv[2]}/index.html"   	 
...
#	chown="chown ${csv[2]} /var/www/htdocs/${csv[2]}"
#	echo $chown
#	eval $chown
#	chown="chown ${csv[2]} /var/www/htdocs/${csv[2]}/index.html"
#	echo $chown
#	eval $chown

#    	#this is no longer needed, i have added .bash_profile to /etc/skel
#    	#.bash_profile
	##create .bashrc to point to bash profile - this apparently 
########fixes xfce issues not loading a PATH
    	bash="echo \". ~/.bash_profile\" > /home/${csv[2]}/.bashrc"
	eval $bash
	bash="echo \"PATH=/usr/rbin\" > /home/${csv[2]}/.bash_profile"
    	eval $bash
	bash="echo \"export PATH\" >> /home/${csv[2]}/.bash_profile"
	eval $bash
	bash="echo \"ulimit -u 30\" >> /home/${csv[2]}/.bash_profile" #no. processes
	eval $bash
#	bash="echo \"ulimit -t 60\" >> /home/${csv[2]}/.bash_profile" #process cpu time
#	eval $bash
	bash="echo \"ulimit -m 10240\" >> /home/${csv[2]}/.bash_profle" #memory usage
	eval $bash
	bash="echo \"ulimit -v 10240\" >> /home/${csv[2]}/.bash_profile" #total virtual memory usage
	eval $bash
...
ulimit -v 10240
	eval $bash
	bash="chown root:root /home/${csv[2]}/.bash_profile"
	eval $bash
	bash="chmod 755 /home/${csv[2]}/.bash_profile"
	eval $bash
#    	#echo $bash
...
#    	chmod their home directory so only they can open it
   ...
   # 	eval $chmod
	...
	##for reference##
    	...
    	echo "id: ${csv[3]}"
	##for fixing rdp##
#	fix="rm /home/${csv[2]}/.xinitrc"
#	eval $fix
#	fix="rm /home/${csv[2]}/.xsession"
#	eval $fix
#	fix="rm /home/${csv[2]}/.xwmconfig"
#	eval $fix
#	fix="rm /home/${csv[2]}/.screenrc"
#	eval $fix
#	fix="cp -r /home/test_student/.xrdp-* /home/${csv[2]}/"
#	eval $fix
#	fix="chown ${csv[2]} /home/${csv[2]}/.xrdp-*"
#	eval $fix
